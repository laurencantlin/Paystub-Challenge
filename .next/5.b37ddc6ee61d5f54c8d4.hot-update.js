...
function (_React$Component) {
  ...
  function EmployeeForm() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = EmployeeForm.__proto__ || Object.getPrototypeOf(EmployeeForm)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      enumerable: true,
      writable: true,
      value: function value(_value6, setPeriodStartChange) {
        // console.log(e.target.value)
        _this.setState({
          PeriodStartChange: _value6
        }, function () {
          return setPeriodStartChange(_this.state.PeriodStartChange);
        });
      }
    }), _temp));
  }
...
//# sourceMappingURL=5.b37ddc6ee61d5f54c8d4.hot-update.js.map