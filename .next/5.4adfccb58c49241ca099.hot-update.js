  ...
  function Slip() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Slip.__proto__ || Object.getPrototypeOf(Slip)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "renderDate", {
      ...
      value: function value(cts) {
        console.log("cts", __WEBPACK_IMPORTED_MODULE_5_moment___default()(cts).format('ll'));
        var formattedDate = __WEBPACK_IMPORTED_MODULE_5_moment___default()(cts).format('ll');
      ...
      writable: true,
      value: function value(income) {
        console.log(income); // const Gross = income / 12 return Gross
      }
    }), Object.defineProperty(_assertThisInitialized(_this), "renderSuper", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(supr) {
        console.log(supr); // const Gross = income / 12 return Gross
      }
    }), _temp));
  }
  ...
  _createClass(Slip, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__config_Context__["a" /* default */].Consumer, {
        ...
        }, "$", _this2.renderNetIncome(_this2.renderIncomeTax(context.state.AnnualSalary, context.state.TaxBrackets)))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("tr", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 103
          }
        ...
        }, _this2.renderSuper(context.state.AnnualSalary, context.state.Super)))))));
      });
    }
  }, {
...
//# sourceMappingURL=5.4adfccb58c49241ca099.hot-update.js.map